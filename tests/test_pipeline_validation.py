...
def _write_reports(outputs) -> None:
    ...
    for name in [
        ...
        "trading_run_monitor.md",
        "trading_run_health.md",
        "intraday_monitor_report.md",
        "qmt_smoke_test.md",
        "readiness_report.md",
...
def _paths(processed, outputs):
    return {
        ...
        "position_reconciliation_report": outputs / "position_reconciliation.md",
        "trading_run_monitor": outputs / "trading_run_monitor.md",
        "trading_run_health": outputs / "trading_run_health.md",
        "intraday_monitor_report": outputs / "intraday_monitor_report.md",
        "qmt_smoke_test_report": outputs / "qmt_smoke_test.md",
        "readiness_report": outputs / "readiness_report.md",
