...
下一步建议补充资金曲线和组合再平衡，让回测从单笔交易统计升级为组合级收益评估。自动交易仍建议最后再接。
